...
/**
 * Парсит информацию о кредитных организациях
 * @author Volkov Mikhail
 */
public class CreditInfoParser extends HtmlParser<CreditInfo> {

    public List<CreditInfo> parseUrl(String url) throws IOException {
        ...
        for (int i = 0; i < partnerLinks.size(); i++) {
            ...
            creditList.add(new CreditInfo(partnerLink, creditTime, creditSumm, methodText, interestRate, timeOfConsideration, imageLink));
